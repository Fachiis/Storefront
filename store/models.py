    """
    This module provides the function to create Store Data Model which comprises of a Product, Customer and Order object.
    """
...
class Customer(models.Model):
    ...
    membership = models.CharField(max_length=6, choices=MEMBERSHIP_CHOICES, default=MEMBERSHIP_BRONZE)
